               ...
               <form action="{{route('simpan-pasien')}}" method="post">
                 ...
                 <div class="col-sm-6">
                    ...
                    <label>Nama Pasien</label>
                      <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Pasien">
                    </div>

                    <div class="form-group">
                      <label>Alamat Pasien</label>
                      <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Alamat Pasien ..."></textarea>
                    </div>
                 ...
                 <div class="row">
                  <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir Pasien">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
